...
#if SIMPAPP == -1
	appstoload.push_back("/sdcard/zap2016.prc");
#elif SIMPAPP == 0
	appstoload.push_back("/sdcard/mulg.prc");
	appstoload.push_back("/sdcard/test.pdb");
#elif SIMPAPP == 1
...
#elif SIMPAPP == 6
	appstoload.push_back("/sdcard/invaders.prc");
#elif SIMPAPP == 7
